...
Sway allows you to arrange your application windows _logically_, rather than _spatially_.
...
After reboot, it is time to set your password. [**NOTE**: Keep the Gnome session active. Do _not_ switch to the Sway session!]
